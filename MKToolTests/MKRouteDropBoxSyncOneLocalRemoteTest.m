...
@interface MKRouteDropBoxSyncOneLocalRemoteTest : MKTDropboxBaseTest<MKTRouteDropboxControllerDelegate> {
  NSString *tmpFile;  
  NSString *dataPath;
...
@implementation MKRouteDropBoxSyncOneLocalRemoteTest
